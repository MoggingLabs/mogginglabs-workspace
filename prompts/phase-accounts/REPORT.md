...
| 07 | BYTECODE | `out/bytecode-result.json` (static) | main ships `.jsc` this Electron's V8 accepts; preload stays readable + sandboxed; pinned constants don't grep; the daemon-plain exception (ADR 0016) asserted both ways |
