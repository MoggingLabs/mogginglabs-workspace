...
| 7 | `phase-7/` | 01–02 done, rest authored | Usage meters — **full CodexBar parity** (~57 providers on 5 mechanism classes: cli-store · api-key · cloud-cli · web-session · local): adapter seam + ADR 0007/0007.b, pace engine, titlebar gauge + popover, cost/spend/history, provider status feed, merged-icon display, reset confetti, `mogging usage` CLI, full Usage settings tab (research: `docs/research/2026-07-codexbar-parity.md`) |
