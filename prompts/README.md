...
| 7 | `phase-7/` | authored, ready | Usage meters: adapter seam + ADR 0007, pace engine, titlebar gauge + popover, plans × profiles, full Usage settings tab (IMPLEMENTATION.md surveyed 2026-07-06 — can start now) |
