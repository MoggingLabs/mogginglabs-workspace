...
| 05b | `05b-agent-browser-control.md` | Agents get the wheel: full browser control (navigate/snapshot/screenshot/click/type/eval/console/network/wait) as MCP tools on the phase-8 server; per-workspace consent default OFF, visible possession + one-click revoke (smoke green). Needs 05 + phase-8/02 |
