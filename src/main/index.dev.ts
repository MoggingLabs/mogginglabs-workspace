...
const SMOKE_ENV: readonly string[] = [
  ...
  'MOGGING_FOLDERPICK', 'MOGGING_SETSHELL', 'MOGGING_SETAGENTCFG', 'MOGGING_SETINTEG', 'MOGGING_CONNLIVE', 'MOGGING_TOOLPULSE', 'MOGGING_TOOLWHO', 'MOGGING_TOOLCARDS', 'MOGGING_TOOLFIX', 'MOGGING_TOOLSMILESTONE', 'MOGGING_LIBRARYUX', 'MOGGING_SETUSAGE', 'MOGGING_HOMEUX', 'MOGGING_RESUME',
