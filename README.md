...
> plus the accounts pack (the optional Pro tier, hardened — `docs/18-accounts.md`);
> the current release is the version in `package.json`. The `qa-smokes.sh`
> sweep now runs **144 gates** across three OSes. Per-phase receipts and measured numbers
