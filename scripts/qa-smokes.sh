...
#
# 201 gates: 29 static (AUDIT · SPACING · PTYSEAM · PROTOVER · CHANNELS · AGENTCAT · LAYOUT ·
...
# GRAMMARCAT · CATSCHEMA · TOOLWORDS · TOOLCRED · RESTEXEC · RESTIMPORT · FONTCOVER) + 172 app-boot
...
run_smoke PROFILEDEFAULTS MOGGING_PROFILEDEFAULTS 1 180 profiledefaults
